...
<head>
    ...
    <style>
        body {
            background-color:rgb(133, 111, 117); /* Dark Maroon */
        ...
        <div class="container mt-5">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if ($application->status === 'rejected' && $application->cancellation_reason)
                ...
                <div class="text-center card-footer">
                    <a href="{{ url('showapplication') }}" class="btn btn-outline-success">
