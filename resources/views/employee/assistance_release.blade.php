        ...
        <div class="container">
            <div class="card" align="center" style="padding-top:80px;">
                <div class="card-header">
                    Track the Release of Assistance or Benefits
                </div>
                <form class="mb-3">
                    <div class="row">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                @if (request()->name_of_assistance !== null)
                                <th>Action</th>
                                @endif
                            </tr>
                        </thead>
                        <tbody>
                            @forelse ($beneficiaries as $beneficiary)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{ $beneficiary->benefitsReceived->where('status', 'Not Received')->count() }}
                                        <br>
                                    </td>
                                    @if (request()->name_of_assistance !== null)
                                    <td>
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            @if ($benefit?->assistance?->name_of_assistance === request()->name_of_assistance && $benefit?->status === 'Pending')
                                            <div>
                                            <form
                                            ...
                                            @elseif($benefit?->assistance?->name_of_assistance === request()->name_of_assistance && $benefit?->status === 'Received')
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    value="{{ $beneficiary?->date_of_birth?->format('F d, Y') }}"
                                                                    disabled>
                                                            </div>
                                                            <div class="form-group">
                            ...
                            @empty
                                <tr>
                                    <td @if (request()->name_of_assistance !== null) colspan="9" @else colspan="8" @endif class="text-center">
                                        {{ request()->name_of_assistance !== null ? 'No assistance found' : 'No assistance added yet' }}
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
