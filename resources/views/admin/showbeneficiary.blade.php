                                ...
                                @forelse ($data as $item)
                                    @if ($item->source === 'Beneficiary')
                                        <tr>
                                            ...
                                            {{--  <td><span
                                                    class="badge rounded-pill text-capitalize {{ $item?->status === 'approved' ? 'bg-success' : ($item?->status === 'pending' ? 'bg-warning' : ($item->status === 'rejected' ? 'bg-danger' : ($item?->status === 'accepted' ? 'bg-primary' : 'bg-info'))) }}">{{ $item?->status ?? 'Manual' }}</span>
                                            </td>  --}}
                                                    ...
                                                    <div x-cloak x-show="open">
                                                        <div class="gap-2 d-flex justify-content-around flex-column">
                                                            ...
                                                            @else
                                                                ...
                                                                @elseif(
                                                                    $item?->service->name ===
                                                                        "AICS(Assistance to Individuals in
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    Crisis)")
                                                                    <a class="btn btn-success btn-sm ms-2"
