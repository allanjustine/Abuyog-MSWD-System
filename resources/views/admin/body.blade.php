            ...
            <div class="main-panel" style="padding-top: 10%;">
                <div class="row">
                    ...
                    <div class="col-sm-3 col-6">
                        <div class="card p-1">
                            <div class="card-body p-2">
                                <h6 class="mb-1 fw-bold fs-5">Total Services</h6>
                                <div class="d-flex align-items-center justify-content-between w-100">
                                    <h4 class="mb-0">{{ $totalServices }}</h4>
                                    <i class="icon-md mdi mdi-assistant text-muted"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-6">
                        <div class="card p-1">
                            <div class="card-body p-2">
                                <h6 class="mb-1 fw-bold fs-5">Total Users</h6>
                                <div class="d-flex align-items-center justify-content-between w-100">
                                    <h4 class="mb-0">{{ $totalUsers }}</h4>
                                    <i class="icon-md mdi mdi-account-multiple-plus text-success"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-6">
                        <div class="card p-2 mt-3">
                            <div class="card-body p-2">
                                <h6 class="mb-1 fw-bold fs-5">Released Applications</h6>
                                <div class="d-flex align-items-center justify-content-between w-100">
                                    <h4 class="mb-0">{{ $releasedBeneficiary }}</h4>
                                    <i class="icon-md mdi mdi-rocket text-warning"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-6">
                        <div class="card p-2 mt-3">
                            <div class="card-body p-2">
                                <h6 class="mb-1 fw-bold fs-5">Accepted Applications</h6>
                                <div class="d-flex align-items-center justify-content-between w-100">
                                    <h4 class="mb-0">{{ $acceptedBeneficiary }}</h4>
                                    <i class="icon-md mdi mdi-check-all text-info"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 col-6">
                        <div class="card p-2 mt-3">
                            <div class="card-body p-2">
                                ...
                                <div class="d-flex align-items-center justify-content-between w-100">
                                    <h4 class="mb-0">{{ $pendingBeneficiary }}</h4>
                    ...
                    <div class="col-sm-3 col-6">
                        <div class="card p-2 mt-3">
                            <div class="card-body p-2">
                                <h6 class="mb-1 fw-bold fs-5">Rejected Applications</h6>
                                <div class="d-flex align-items-center justify-content-between w-100">
                                    <h4 class="mb-0">{{ $rejectedBeneficiary }}</h4>
