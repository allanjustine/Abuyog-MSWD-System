                            ...
                            <fieldset class="p-3 mb-3 border">
                                ...
                                <div class="row form-row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="occupation" value="{{ $beneficiary->occupation }}" name="occupation">
                                        @error('occupation')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="other_skills" name="other_skills" value="{{ $beneficiary->other_skills }}">
                                        @error('other_skills')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div @if($index % 2) style="background-color:rgba(0, 0, 0, 0.136);" @endif class="p-2 rounded">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select name="income[{{ $fc->id }}]" class="form-select" id="income">
                                                <option value="" hidden selected>Select Income</option>
                                                <option value="" disabled>Select Income</option>
