                            ...
                            <fieldset class="p-3 mb-3 border">
                                ...
                                <div @if($index % 2) style="background-color:rgba(0, 0, 0, 0.136);" @endif class="p-2 rounded">
                                    <div class="row form-row">
                                        ...
                                        <div class="col-md-3">
                                            <label for="age" class="form-label">Age</label>
                                            <input type="number" class="form-control" id="ageFc" name="age_fc[{{ $fc->id }}]" value="{{ $fc->age ?? '' }}">
                                            @error('age_fc.*')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="mt-2 border-b family-member family-member-row" id="familyMemberFields">
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-md-3">
                                            <label for="dateOfBirth" class="form-label">Birthday</label>
                                            <input type="date" class="form-control" id="dateOfBirthFc" name="birthday[]" value="{{ old('birthday.0') }}">
                                            @error('birthday.*')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="col-md-3">
                                            <label for="age" class="form-label">Age</label>
                                            <input type="number" class="form-control" id="ageFc" name="age_fc[]" value="{{ old('age.0') }}">
                                            @error('age_fc.*')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                            ...
                            <fieldset class="p-3 mb-3 border">
                                ...
                                <div class="row form-row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="company_agency" name="company_agency" value="{{ $beneficiary?->soloParentDetails[0]?->company_agency ?? '' }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select" id="4psBeneficiary" name="four_ps_beneficiary">
                                            <option value="">Select</option>
                                            <option value="yes" {{ isset($beneficiary->soloParentDetails[0]) && $beneficiary?->soloParentDetails[0]?->four_ps_beneficiary == 'yes' ? 'selected' : '' }}>Yes</option>
                                            <option value="no" {{ isset($beneficiary->soloParentDetails[0]) && $beneficiary?->soloParentDetails[0]?->four_ps_beneficiary == 'no' ? 'selected' : '' }}>No</option>
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select" id="indigenousPerson" name="indigenous_person">
                                            <option value="">Select</option>
                                            <option value="yes" {{ isset($beneficiary->soloParentDetails[0]) && $beneficiary?->soloParentDetails[0]?->indigenous_person == 'yes' ? 'selected' : '' }}>Yes</option>
                                            <option value="no" {{ isset($beneficiary->soloParentDetails[0]) && $beneficiary?->soloParentDetails[0]?->indigenous_person == 'no' ? 'selected' : '' }}>No</option>
                                        </select>
                                ...
                                <div class="row form-row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="emergencyName" name="emergency_name" value="{{ $beneficiary->contactEmergencies[0]->name ?? '' }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="emergencyAddress" name="emergency_address" value="{{ $beneficiary->contactEmergencies[0]->address ?? '' }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="phone" name="emergency_contact_number" value="{{ $beneficiary->contactEmergencies[0]->contact_number ?? '' }}">
