                                        ...
                                        <div class="row form-row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-select" id="gender"
                                                    name="gender_fc[{{ $fc->id }}]">
                                                    <option value="">Select</option>
                                                    <option value="Male"
                                                        {{ $fc->gender == 'Male' ? 'selected' : '' }}>Male</option>
                                                    <option value="Female"
                                                        {{ $fc->gender == 'Female' ? 'selected' : '' }}>Female</option>
                                                </select>
                                                @error('gender_fc.*')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                        ...
                                        <div class="row form-row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select class="form-select" id="gender" name="gender_fc[]">
                                                    <option value="">Select</option>
                                                    <option value="Male"
                                                        {{ old('gender_fc.0') == 'Male' ? 'selected' : '' }}>Male
                                                    </option>
                                                    <option value="Female"
                                                        {{ old('gender_fc.0') == 'Female' ? 'selected' : '' }}>Female
                                                    </option>
                                                </select>
                                                @error('gender_fc.*')
                                                    <small class="text-danger">{{ $message }}</small>
                                        ...
                                        <div class="row form-row">
                                            <div class="col-md-4">
                                                ...
                                                <select class="form-select" id="civilStatus"
                                                    ...
                                                    <option value="" disabled>Select</option>
                                                    <option value="Single"
                                                        {{ old('civil_status.0') == 'Single' ? 'selected' : '' }}>
                                                        Single</option>
                                                    <option value="Married"
                                                        {{ old('civil_status.0') == 'Married' ? 'selected' : '' }}>
                                                        Married</option>
                                                    <option value="Widowed"
                                                        {{ old('civil_status.0') == 'Widowed' ? 'selected' : '' }}>
                                                        Widowed</option>
                                                    <option value="Divorced"
                                                        {{ old('civil_status.0') == 'Divorced' ? 'selected' : '' }}>
                                                        Divorced</option>
                                                </select>
                                                @error('civil_status_fc.*')
                                                    <small class="text-danger">{{ $message }}</small>
                                ...
                                <div class="row form-row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="caseNo" name="case_no"
                                            value="{{ $beneficiary?->aicsDetails[0]->case_no ?? '' }}">
                                        @error('case_no')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select" id="new_or_old" name="new_or_old">
                                            <option value="">Select</option>
                                            <option value="New"
                                                {{ isset($beneficiary->aicsDetails[0]) && $beneficiary->aicsDetails[0]->new_or_old == 'New' ? 'selected' : '' }}>
                                                New</option>
                                            <option value="Old"
                                                {{ isset($beneficiary->aicsDetails[0]) && $beneficiary->aicsDetails[0]->new_or_old == 'Old' ? 'selected' : '' }}>
                                                Old</option>
                                        </select>
                                        @error('new_or_old')
                                            <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="date" class="form-control" id="dateApplied"
                                            name="date_applied"
                                            value="{{ isset($beneficiary->aicsDetails[0]) ? $beneficiary->aicsDetails[0]->date_applied->format('Y-m-d') : '' }}">
                                        @error('date_applied')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row form-row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="sourceReferral"
                                            ...
                                            value="{{ isset($beneficiary->aicsDetails[0]) ? $beneficiary->aicsDetails[0]->source_of_referral : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="problemPresented"
                                            ...
                                            value="{{ isset($beneficiary->aicsDetails[0]) ? $beneficiary->aicsDetails[0]->problem_presented : '' }}">
