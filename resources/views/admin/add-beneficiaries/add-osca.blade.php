...
<body>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select class="form-select" id="educationalAttainment"
                                            ...
                                            <option value="No Formal Education"
                                                {{ old('educational_attainment') == 'No Formal Education' ? 'selected' : '' }}>
                                                No Formal Education</option>
                                            <option value="Elementary"
                                                {{ old('educational_attainment') == 'Elementary' ? 'selected' : '' }}>
                                                Elementary</option>
                                            <option value="High School"
                                                {{ old('educational_attainment') == 'High School' ? 'selected' : '' }}>
                                                High School</option>
                                            <option value="College"
                                                {{ old('educational_attainment') == 'College' ? 'selected' : '' }}>
                                                College</option>
                                            <option value="Postgraduate"
                                                {{ old('educational_attainment') == 'Postgraduate' ? 'selected' : '' }}>
                                                Postgraduate</option>
                                        </select>
                                ...
                                <div class="row form-row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="annual_income" class="form-select" id="annualIncome">
                                            ...
                                            <option value="Below 60,000"
                                                {{ old('annual_income') == 'Below 60,000' ? 'selected' : '' }}>Below
                                                60,000</option>
                                            <option value="60,000 - 120,000"
                                                {{ old('annual_income') == '60,000 - 120,000' ? 'selected' : '' }}>
                                                60,000 - 120,000</option>
                                            <option value="120,000 - 180,000"
                                                {{ old('annual_income') == '120,000 - 180,000' ? 'selected' : '' }}>
                                                120,000 - 180,000</option>
                                            <option value="Above 180,000"
                                                {{ old('annual_income') == 'Above 180,000' ? 'selected' : '' }}>Above
                                                180,000</option>
                                        </select>
                                        @error('annual_income')
                                            <small class="text-danger">{{ $message }}</small>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="other_skills"
                                            name="other_skills" value="{{ old('other_skills') }}">
                                        @error('other_skills')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
    ...
    <script>
        document.getElementById('formDiv').addEventListener('submit', function(event) {
            ...
            document.querySelectorAll('#formDiv input, #formDiv textarea, #formDiv select').forEach(function(
            field) {
