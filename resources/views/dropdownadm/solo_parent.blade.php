        ...
        <div class="container">
            <div class="card" align="center" style="padding-top:80px;">
                <div class="card-header">
                    Solo Parent
                    <a href="/add-solo-parent" class="btn btn-success btn-sm float-end ms-2">Add
                        New</a>

                    <!-- Button for Send SMS to All -->
                    <a href="#" class="btn btn-primary btn-sm float-end ms-2" id="sendBulkSmsBtn">
                                ...
                                <td>
                                    <div class="d-flex justify-content-around">
                                        ...
                                        <a class="btn btn-success btn-sm ms-2"
                                            href="/edit-solo-parent/{{ $beneficiary->id }}">Edit</a>
