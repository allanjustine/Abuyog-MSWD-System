...
<div class="container-fluid page-body-wrapper">
    ...
    <nav class="flex-row p-0 navbar fixed-top d-flex">
        <div class="navbar-brand-wrapper d-flex d-lg-none align-items-center justify-content-center">
            {{--  <a class="navbar-brand brand-logo-mini" href="index.html"><img src="../assets/img/mswd-logo.png"  --}}
            alt="logo" /></a>
        </div>
        <div class="navbar-menu-wrapper d-flex align-items-center"> <!-- Removed flex-grow and align-items-stretch -->
            ...
            <button class="navbar-toggler navbar-toggler-left d-lg-none align-self-center" type="button"
